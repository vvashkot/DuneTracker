-- Dune Tracker Database Import for Hostinger
-- Database: u442226222_dune_tracker
-- Generated: Wed Aug  6 19:28:29 EDT 2025
...
-- Future database changes should be added as new migration files

-- ============================================
-- Applying: 002_add_farming_runs.sql
-- ============================================
-- Migration: 002_add_farming_runs.sql
-- Description: Add farming runs/sessions tracking
-- Date: 2025-08-03
-- Table for farming runs/sessions
CREATE TABLE  farming_runs (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE  run_refined_outputs (
    id INT AUTO_INCREMENT PRIMARY KEY,
    run_id INT NOT NULL,
...
-- ============================================
-- Applying: 003_simplify_resources.sql
-- ============================================
...
-- ============================================
-- Applying: 004_update_crafting_chains.sql
-- ============================================
...
-- ============================================
-- Applying: 005_update_melange_recipe.sql
-- ============================================
...
-- ============================================
-- Applying: 006_simplify_categories.sql
-- ============================================
...
-- ============================================
-- Applying: 008_simplify_farming_runs.sql
-- ============================================
...
-- ============================================
-- Applying: 009_add_admin_role.sql
-- ============================================
...
-- ============================================
-- Applying: 010_add_manual_users.sql
-- ============================================
...
-- ============================================
-- Applying: 011_add_resource_goals.sql
-- ============================================
...
-- ============================================
-- Applying: 012_farming_run_enhancements.sql
-- ============================================
...
CREATE TABLE  run_distributions (
    id INT AUTO_INCREMENT PRIMARY KEY,
    run_id INT NOT NULL,
    resource_id INT NOT NULL,
...
-- ============================================
-- Applying: 013_allow_null_created_by.sql
-- ============================================
...
-- ============================================
-- Applying: 014_add_user_approval.sql
-- ============================================
...
-- ============================================
-- Applying: 015_add_discord_webhooks.sql
-- ============================================
...
-- ============================================
-- Applying: 016_add_guild_tax_system_fix.sql
-- ============================================
...
-- ============================================
-- Applying: 016_add_guild_tax_system.sql
-- ============================================
...
-- ============================================
-- Applying: 016b_add_current_stock.sql
-- ============================================
...
-- ============================================
-- Applying: 017_add_withdrawals_system_fix.sql
-- ============================================
...
-- ============================================
-- Applying: 017_add_withdrawals_system.sql
-- ============================================
...
(4, 'Update crafting chains'),
(5, 'Update melange recipe'),
(6, 'Simplify categories'),
(7, 'Remove water'),
(8, 'Simplify farming runs'),
(9, 'Add admin role'),
(10, 'Add manual users'),
(11, 'Add resource goals'),
(12, 'Farming run enhancements'),
(13, 'Allow null created_by'),
(14, 'Add user approval'),
(15, 'Add Discord webhooks'),
(16, 'Add guild tax system'),
(17, 'Add withdrawals system');
