...
INSERT INTO migrations (version, description) VALUES (2, 'Add farming runs and refinement tracking');-- Migration: 003_simplify_resources.sql
...
-- Record this migration
INSERT INTO migrations (version, description) VALUES (3, 'Simplify resources to core four');-- Migration: 004_update_crafting_chains.sql
...
-- Record this migration
INSERT INTO migrations (version, description) VALUES (4, 'Add proper crafting chains for Stravidium and Plastanium');-- Migration: 005_update_melange_recipe.sql
...
-- Record this migration
INSERT INTO migrations (version, description) VALUES (5, 'Update Melange to use proper crafting recipe');-- Migration: 006_simplify_categories.sql
...
-- Record this migration
INSERT INTO migrations (version, description) VALUES (6, 'Simplify categories to Raw Materials and Refined');-- Migration: 007_remove_water.sql
...
-- Record this migration
INSERT INTO migrations (version, description) VALUES (7, 'Remove water from resources and recipes');-- Migration: 008_simplify_farming_runs.sql
...
-- Record this migration
INSERT INTO migrations (version, description) VALUES (8, 'Add run_number for auto-incrementing run names');-- Migration: 009_add_admin_role.sql
...
-- Record this migration
INSERT INTO migrations (version, description) VALUES (9, 'Add admin role system and activity logs');-- Migration: 010_add_manual_users.sql
...
-- Record this migration
INSERT INTO migrations (version, description) VALUES (10, 'Add support for manual users without Discord');-- Migration: 011_add_resource_goals.sql
...
-- Record this migration
INSERT INTO migrations (version, description) VALUES (11, 'Add resource goals and leaderboard tracking');-- Migration: 012_farming_run_enhancements.sql
...
-- Record this migration
INSERT INTO migrations (version, description) VALUES (12, 'Add farming run scheduling, templates, distributions, and metrics');-- Migration: 013_allow_null_created_by.sql
...
-- Record this migration
INSERT INTO migrations (version, description) VALUES (13, 'Allow NULL in created_by columns for user deletion');-- Migration: 014_add_user_approval.sql
...
-- Record this migration
INSERT INTO migrations (version, description) VALUES (14, 'Add user approval system');-- Migration: 015_add_discord_webhooks.sql
...
-- Record this migration
INSERT INTO migrations (version, description) VALUES (15, 'Add Discord webhook support');-- Migration: 016_add_guild_tax_system_fix.sql
...
-- Record this migration
INSERT INTO migrations (version, description) VALUES (16, 'Add guild tax system');-- Migration: 016b_add_current_stock.sql
