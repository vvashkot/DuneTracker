-- Dune Tracker Complete Database Import for Hostinger
-- Database: u442226222_dune_tracker

-- Disable foreign key checks for entire import
...
-- Apply migrations without the INSERT statements and without duplicate ALTERs
...
-- ============================================
-- Applying user approval migration with fixes
-- Migration: 014_add_user_approval.sql
